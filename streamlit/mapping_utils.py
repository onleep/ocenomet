...
column_order = [
    ...
    "Этаж", "Кол-во этажей", "Год постройки",

    # Местоположение
    "Метро", "Время до метро (мин)", "Округ", "Район", "Расстояние до центра (км)",

    # Тип и состояние жилья
    "Тип жилья", "Тип материала", "Тип ремонта", "Способ передвижения", "Категория",

    # Дополнительные характеристики
    "Тип сделки", "Кол-во просмотров", "Кол-во фотографий", "Кол-во отзывов застройщика", "Рейтинг застройщика ", 
    "Ипотека разрешена", "Премиум", "Аварийное состояние", "Реновация", 
    "Пентхаус", "Апартаменты",

    # Информация о доме
    "Кол-во подъездов", "Тип парковки", "Кол-во лифтов", "Кол-во пассажирских лифтов", "Грузовые лифты", "Вид из окон",

    # Инфраструктура и удобства
    "Кол-во балконов", "Кол-во лоджий", "Мусоропровод", "Высота потолков (м)", "Раздельный санузел", "Совмещённый санузел",

    # Параметры застройщика и агентства
    "Название застройщика", "Кол-во зданий застройщика", "Год основания застройщика", 
    "Надежность застройщика", "Название агентства", "Описание",

    # Технические характеристики
    "Тип недвижимости", "Тип отопления", "Тип газа", "Координаты (широта)", "Координаты (долгота)",

    # Дата публикации
    "Год публикации", "Месяц публикации", "День недели публикации", "День месяца публикации", "Дата публикации",

    # Прочие параметры
    "id объявления", "Улица", "Дом"
]
