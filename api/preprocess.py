...
def preprepict(data) -> pd.DataFrame:
    ...
    data['rooms_count'] = data['rooms_count'].fillna(data['living_area'] * mean_proportion_rooms_count)\
        .astype(int)
    ...
    data['views_count'] = data['views_count'].astype(int)
    data['balconies'] = data['balconies'].astype(int)
    data['loggias'] = data['loggias'].astype(int)
    data['separated_wc'] = data['separated_wc'].astype(int)
    data['combined_wc'] = data['combined_wc'].astype(int)
